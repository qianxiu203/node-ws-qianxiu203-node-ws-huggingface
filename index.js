...
const UUID = process.env.UUID || 'b8efd8c7-b41d-499d-986c-7af28a83b4a4'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
const NEZHA_SERVER = process.env.NEZHA_SERVER || 'jk.qianxiu.xx.kg:8008';       // 哪吒v1填写形式：nz.abc.com:8008   哪吒v0填写形式：nz.abc.com
const NEZHA_PORT = process.env.NEZHA_PORT || '';           // 哪吒v1没有此变量，v0的agent端口为{443,8443,2096,2087,2083,2053}其中之一时开启tls
const NEZHA_KEY = process.env.NEZHA_KEY || 'tWSZ7FQDZuV2wlCshjCddTNsV4Fb9Z5p';             // v1的NZ_CLIENT_SECRET或v0的agent端口                
...
const SUB_PATH = process.env.SUB_PATH || 'qianxiuadmin';            // 获取节点的订阅路径
